	...
	<body>
        ...
        <script>
            ...
            searchField.on("keydown", function(event) {
                //Must set timeout to give time for the field register its new value
                setTimeout(function() { onSearch(searchField.val(), event.keyCode) }, 1);    
            })
            ...
            function onSearch(fieldValue, lastKey) {
                ...
                $.get("general_search.php", { search_query: fieldValue }, function(result) {
                    searchResults.empty();  //Remove all search results childs
                    searchResults.append("<div class='search-result'>" + result + "</div>");             
                    //console.log(result);
                });     
            }
